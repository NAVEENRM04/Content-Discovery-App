...
const changePassword=(email,password,code)=>axios.put(`http://localhost:8080/updatePassword/${email}/${password}/${code}`,{code:code})
...
export {userRegister,userLogin,checkCode,getCode,changePassword,getUserDetail,updateProfilepic,addImage,userDetail,TdeleteUser};